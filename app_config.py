...
PROJECT_SLUG = 'naughty-or-nice'

# Project name to be used in file paths
PROJECT_FILENAME = 'naughty_list'

# The name of the repository containing the source
REPOSITORY_NAME = 'naughty-list'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_URL = 'https://docs.google.com/spreadsheet/ccc?key=0Alg9G6ua2W2fdGllWnZYTXpacmNuMWljSWttTlVqOGc&usp=drive_web#gid=1'
...
DISQUS_UUID = '7f08f933-8548-11e4-ae95-80e650107db6'
